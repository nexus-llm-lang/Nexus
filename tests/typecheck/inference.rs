...
fn test_gravity_rule_immutable_holds_value() {
    let src = std::fs::read_to_string("tests/fixtures/test_gravity_rule_immutable_holds_value.nx")
        .expect("fixture should exist");
    should_typecheck(&src);
}
...
#[test]
fn test_ref_generic() {
    let src = std::fs::read_to_string("tests/fixtures/test_ref_generic.nx")
        .expect("fixture should exist");
    should_typecheck(&src);
}
